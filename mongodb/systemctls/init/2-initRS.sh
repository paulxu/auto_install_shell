...
do
        ...
        echo -e "\033[33m-----------$MONGO_HOME/bin/mongo dscn$j:$port_num----------- \033[0m"

        $MONGO_HOME/bin/mongo dscn$j:$port_num <<EOF
        config={_id:"TOD-Shard-$rs_num",
                members:[
                        {_id:0,host:"dscn$current_rs:$port_num",priority:2},
                        {_id:1,host:"dscn$left_rs:$port_num"},
                        {_id:2,host:"dscn$right_rs:$port_num"}],
