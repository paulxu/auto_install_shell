...
do
        ...
        then
         ...
         echo -e "\033[33m-----------[TOD-Shard-$rs_num/dscn$current_rs:$port_num,dscn$left_rs:$port_num,dscn$right_rs:$port_num]----------- \033[0m"
	$MONGO_HOME/bin/mongo dscn1:27017 <<EOF
	sh.addShard("TOD-Shard-$rs_num/dscn$current_rs:$port_num,dscn$left_rs:$port_num,dscn$right_rs:$port_num");
